...
define(['jquery', 'core/ajax', 'core/templates', 'core/notification', 'core/str', 'core/config'],
    function($, ajax, templates, notification, str, config) {
        ...
        Profile.prototype._init = function() {
            ...
            this.messageArea.onDelegateEvent('click', "[data-action='profile-send-message']", this._viewMessages.bind(this));
         ...
         * @private
         */
        Profile.prototype._viewMessages = function() {
            this.messageArea.trigger('conversation-selected', this._getUserId());
        };
