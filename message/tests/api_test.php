...
class core_message_api_testcase extends core_message_messagelib_testcase {
    ...
    public function test_get_conversations_some_muted() {
        ...
        $conversation2 = \core_message\api::create_conversation(\core_message\api::MESSAGE_CONVERSATION_TYPE_GROUP,
            [$user1->id, $user2->id]);
        \core_message\api::mute_conversation($user1->id, $conversation2->id);
