...
class core_message_externallib_testcase extends externallib_advanced_testcase {
    ...
    protected function send_message($userfrom, $userto, $message = 'Hello world!', $notification = 0, $time = 0) {
        ...
        if (!$conversation = \core_message\api::get_conversation_between_users($userfrom->id, $userto->id)) {
            $conversation = \core_message\api::create_conversation_between_users($userfrom->id,
                $userto->id);
        }
