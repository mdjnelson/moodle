...
function message_get_recent_conversations($user, $limitfrom=0, $limitto=100) {
    ...
    $sql = "SELECT $userfields,
                   m.id as mid, m.notification, m.smallmessage, m.fullmessage, m.fullmessagehtml,
                   m.fullmessageformat, m.timecreated, mc.id as contactlistid, mc.blocked
              FROM {message_read} m
              JOIN (
