...
class api {
    ...
    public static function delete_conversation($userid, $otheruserid) {
        ...
        $conversation = self::get_conversation_between_users($userid, $otheruserid);
        ...
        $messages = $DB->get_records_sql($sql, [$userid, self::MESSAGE_ACTION_DELETED, $conversation->id]);
     ...
     * @return \stdClass|bool row from the message_conversations table, false if not found
     */
    public static function get_conversation_between_users($userid1, $userid2) {
        ...
        return $DB->get_record_sql($sql, ['userid1' => $userid1, 'userid2' => $userid2]);
    }
     ...
     * @param int $userid1 The userid of the first user
     * @param int $userid2 The userid of the second user
     * @return \stdClass row from the message_conversations table
     */
