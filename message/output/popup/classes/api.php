...
class api {
    ...
    public static function get_popup_notifications($useridto = 0, $sort = 'DESC', $limit = 0, $offset = 0) {
        ...
        $sql = "SELECT n.id, n.useridfrom, n.useridto,
                       ...
                       n.fullmessagehtml, n.smallmessage, n.contexturl, n.contexturlname, n.timecreated,
                       n.timeuserfromdeleted, n.timeusertodeleted, n.component, n.eventtype, n.timeread
