...
abstract class backup_structure_dbops extends backup_dbops {
    ...
    public static function get_iterator($element, $params, $processor) {
        ...
        if ($element->get_source_array() === null && $element->get_source_table() === null &&
            ...
            return $element->get_source_db()->get_recordset($element->get_source_table(),
                self::convert_params_to_values($params, $processor), $element->get_source_table_sortby());

        } else if ($element->get_source_sql() !== null) { // It's one sql, return recordset iterator
            return $element->get_source_db()->get_recordset_sql($element->get_source_sql(),
                self::convert_params_to_values($params, $processor));
