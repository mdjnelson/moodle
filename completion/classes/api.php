...
class api {
    ...
    /**
     * Creates an event for the expected completion date.
     *
     ...
     * @return bool
     */
    public static function update_completion_date_event($cmid, $modulename, $instanceid,
        ...
        if ($event->id = $DB->get_field('event', 'id',
            array('modulename' => $modulename, 'instance' => $instance->id, 'eventtype' => $event->eventtype))) {
