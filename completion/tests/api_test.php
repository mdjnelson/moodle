...
class core_completion_api_testcase extends advanced_testcase {
    ...
    public function test_create_expected_completion_date_event_completion_disabled() {
        global $CFG, $DB;
    ...
    public function test_create_expected_completion_date_event_update_completion_disabled() {
        global $CFG, $DB;
    ...
    public function test_create_expected_completion_date_event_delete_completion_disabled() {
        global $CFG, $DB;
