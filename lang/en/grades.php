...
$string['graderule'] = 'Grading rules';
$string['graderule_sortorder'] = 'Rule order';
$string['graderule_sortorder_help'] = 'The order in which rules are executed';
$string['graderule_appliedrulespopuptitle'] = 'Grading rules\' notes';
$string['graderule_errorsave'] = 'Error: Unable to save record';
$string['graderulesettings'] = 'Graderule settings';
...
$string['notfactoryinterface'] = 'The class does not implement factory_interface';
