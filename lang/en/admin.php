...
$string['configenableactivitychooser'] = 'If enabled, this will allow the user to add a resource or activity via a popup dialog. Otherwise, a drop down will be provided.';
