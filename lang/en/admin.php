...
$string['cannotinstallusingstorageengine'] = 'The database storage engine is set to "{$a->storageengine}" which is no longer supported.';
$string['cannotinstallusingstorageengine_desc'] = '<p>The site administrator should verify the database configuration.</p>';
$string['cannotuninstall'] = '{$a} can not be uninstalled.';
$string['cannotupgradeusingstorageengine'] = 'One or more of the database tables are using the storage engine "{$a->storageengine}" which is no longer supported.';
$string['cannotupgradeusingstorageengine_desc'] = '<p>Try visiting the InnoDB tool <a href="{$a->link}">here</a> to convert the tables.</p>';
