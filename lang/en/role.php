...
$string['disguise:configure'] = 'Configure disguises';
$string['disguise:showidentity'] = 'Reveal identities where they have been set to show to restricted users';
$string['disguise:revealidentity'] = 'Reveal identities at any time';
$string['disguise:disablelock'] = 'Disable a disguise lock';
