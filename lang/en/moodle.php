...
$string['disguise_disabled'] = 'Disabled';
$string['disguise_disabledisguisefrom'] = 'Stop disguising users from';
$string['disguise_forced'] = 'Forced';
$string['disguise_hide'] = 'Hide user identity';
$string['disguise_identity_hidden'] = 'Identity hidden';
$string['disguise_identity_restricted'] = 'Identity restricted to certain users';
$string['disguise_identity_shown'] = 'Identity shown';
$string['disguise_loganonymously'] = 'Log anonymously';
$string['disguise_lockdisguise'] = 'Prevent changes to this disguise';
$string['disguise_mode'] = 'Mode';
$string['disguise_optional'] = 'Optional';
$string['disguise_reveal'] = 'Reveal user disuises';
$string['disguise_showrealidentity'] = 'Show user\'s real identity alongside their disguise';
$string['disguise_type'] = 'Disguise type';
$string['disguiseplugins'] = 'User disguises';
$string['disguisepluginsmanage'] = 'Manage disguises';
$string['disguisesettingsmenu'] = 'Disguise';
$string['disguisemodformtitle'] = 'Disguises';
