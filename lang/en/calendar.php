...
$string['calendartypedeleteconfirm'] = 'You are about to completely delete the calendar type \'{$a}\'. This will completely delete everything in the database associated with this plugin. Are you SURE you want to continue?';
$string['calendartypesmanage'] = 'Manage calendar types';
...
$string['configcalendartype'] = 'Default calendar';
