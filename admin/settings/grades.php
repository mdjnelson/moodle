...
if (has_capability('moodle/grade:manage', $systemcontext)
 or has_capability('moodle/grade:manageletters', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    if ($hassiteconfig) {
        ...
        $temp = new admin_settingpage('managegraderules', new lang_string('managegraderules', 'grades'));
        $temp->add(new admin_setting_managegraderules());

        $ADMIN->add('graderules', $temp);
