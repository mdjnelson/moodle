...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configselect('calendarsystem', new lang_string('configcalendarsystem', 'calendar'), new lang_string('helpcalendarsystem', 'calendar'), 'gregorian', get_list_of_calendars()));
