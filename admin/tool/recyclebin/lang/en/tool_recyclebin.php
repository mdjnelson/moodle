...
$string['emptyconfirm'] = 'Are you sure you want to delete all items from the recycle bin?';
...
$string['eventstored'] = 'Item stored';
$string['eventstored_desc'] = 'Item stored with ID {$a->objectid}.';
$string['eventrestored'] = 'Item restored';
$string['eventrestored_desc'] = 'Item with ID {$a->objectid} restored.';
$string['eventpurged'] = 'Item purged';
$string['eventpurged_desc'] = 'Item with ID {$a->objectid} purged.';
