...
$string['rulehelp_help'] = 'This rule listens for when the event {$a->eventname} has been triggered {$a->frequency} time(s) in {$a->timewindow} seconds.';
...
$string['subhelp_help'] = 'This subscription listens for when the event {$a->eventname} has been triggered {$a->frequency} time(s) in {$a->timewindow} seconds.';
