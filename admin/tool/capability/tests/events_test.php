...
class tool_capability_events_testcase extends advanced_testcase {
    ...
    public function test_report_viewed() {
        // Create the event.
        $event = \tool_capability\event\report_viewed::create(array(
            'courseid' => SITEID,
            'context' => context_system::instance(),
            'other' => array('numcapabilities' => '10')
        ));
        ...
        $expected = array(SITEID, 'admin', 'tool capability', 'tool/capability/index.php', '10');
