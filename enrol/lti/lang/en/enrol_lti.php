...
$string['gradesyncmode_help'] = 'This setting determines when grades are sent to the LTI consumer.';
...
$string['tasksyncgrades'] = 'Task for syncing grades with the consumer';
$string['tasksyncmembers'] = 'Task for syncing members with the consumer';
