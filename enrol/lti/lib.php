...
class enrol_lti_plugin extends enrol_plugin {
    ...
    public function edit_instance_form($instance, MoodleQuickForm $mform, $context) {
        ...
        $options = array();
        $options[ENROL_LTI_GRADE_SYNC_ALWAYS] = get_string('always');
        $options[ENROL_LTI_GRADE_SYNC_DIFFERS] = get_string('gradesyncmodediffer', 'enrol_lti');
        $options[ENROL_LTI_GRADE_SYNC_FIRST_TIME] = get_string('gradesyncmodefirsttime', 'enrol_lti');
        $mform->addElement('select', 'gradesyncmode', get_string('gradesyncmode', 'enrol_lti'), $options);
        $mform->setDefault('gradesyncmode', ENROL_LTI_GRADE_SYNC_DIFFERS);
        $mform->addHelpButton('gradesyncmode', 'gradesyncmode', 'enrol_lti');
        $mform->disabledIf('gradesyncmode', 'gradesync', 0);
