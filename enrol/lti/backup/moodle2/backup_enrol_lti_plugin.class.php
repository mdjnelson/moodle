...
class backup_enrol_lti_plugin extends backup_enrol_plugin {
    ...
    public function define_enrol_plugin_structure() {
        ...
        $tool = new backup_nested_element('tool', array('id'), array(
            ...
            'country', 'gradesync', 'gradesyncmode', 'gradesynccompletion', 'lastgradesynctime', 'membersync',
            'membersyncmode', 'lastmembersynctime',  'roleinstructor', 'rolelearner', 'secret', 'timecreated',
            'timemodified'));
