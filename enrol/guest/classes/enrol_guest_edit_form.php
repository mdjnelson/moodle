...
class enrol_guest_edit_form extends moodleform {
    ...
    public function definition() {
        ...
        // instances we do not force the password to be required as they may have been set before the
        // setting was initialised. We check in the validation function whether this check is required
