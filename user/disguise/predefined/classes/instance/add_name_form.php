...
/**
 * Form for adding names to a disguise instance.
 *
 * @copyright  2016 Andrew Nicols <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class add_name_form extends \moodleform {
    /**
     * Form definition.
     */
    public function definition() {
        $this->_form->addElement('header', 'addnames', get_string('header_add_names_to_disguise', 'disguise_predefined'));
