...
/**
 * Class user_edit_course_form.
 *
 * @copyright 2016 Joey Andres <jandres@ualberta.ca>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_edit_course_form extends moodleform {
    ...
    public function definition () {
        ...
        $activitychooserenabledcheckbox = $mform->addElement('advcheckbox',
            'enableactivitychooser',
            get_string('enableactivitychooser', 'admin'),
            get_string('configenableactivitychooser', 'admin'));
        $activitychooserenabledcheckbox->setChecked(get_user_preferences('usemodchooser', true));
