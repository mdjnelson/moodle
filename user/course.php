...
require_once($CFG->dirroot.'/user/course_form.php');
...
// Create form.
$courseform = new user_edit_course_form(null, array('userid' => $user->id));
...
if ($courseform->is_cancelled()) {
    ...
    if ($USER->id == $user->id) {
        set_user_preference('usemodchooser', $data->enableactivitychooser);
    }
