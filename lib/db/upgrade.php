...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2018012500.01) {
        ...
        $table->add_field('timeuserfromdeleted', XMLDB_TYPE_INTEGER, '10', null, false, null, null);
        $table->add_field('timeusertodeleted', XMLDB_TYPE_INTEGER, '10', null, false, null, null);
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2018012500.01);
    }
