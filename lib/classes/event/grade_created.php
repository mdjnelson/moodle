...
class grade_created extends base {
    ...
    public static function get_name() {
        return get_string('eventgradecreated', 'core_grades');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the grade with id '$this->objectid' for the user with " .
