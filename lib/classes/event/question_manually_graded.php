 ...
 *
 *      @type int attemptid the id of the attempt.
 * }
 *
 * @package    core
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'question');
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['attemptid'])) {
            throw new \coding_exception('The attempt id must be set in $other.');
        }
    }
}
