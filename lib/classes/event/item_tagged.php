 ...
 *
 *      @type int tagid the id of the tag.
 *      @type string tagname the name of the tag.
 *      @type string tagrawname the raw name of the tag.
 *      @type int itemid the id of the item tagged.
 *      @type string itemtype the type of item tagged.
 * }
 *
 * @package    core
...
class item_tagged extends base {
    ...
    public function get_description() {
        return 'The tag with the id ' . $this->other['tagid'] . ' was added to the item type \'' . $this->other['itemtype'] .
