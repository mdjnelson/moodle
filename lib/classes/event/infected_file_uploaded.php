...
class infected_file_uploaded extends base {
    ...
    public function get_description() {
        ...
        return 'An infected file was uploaded by a user with the id ' . $this->userid . '. ' . $stroldfilepath .
            ' ' . $strnewfilepath;
    }
    ...
    protected function validate_data() {
        if (!isset($this->other['oldfilepath'])) {
            throw new \coding_exception('The old file path needs to be set in $other');
        }
        if (!isset($this->other['newfilepath'])) {
            throw new \coding_exception('The new file path needs to be set in $other');
        }
    }
}
