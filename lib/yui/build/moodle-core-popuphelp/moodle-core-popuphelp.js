...
Y.extend(POPUPHELP, Y.Base, {
    ...
    initializer: function() {
        Y.one('body').delegate('click', this.display_panel, 'span.helptooltip > a', this);
        Y.one('body').delegate('click', this.display_custom_panel, 'span.customhelptooltip > a', this);
    },
    ...
    display_panel: function(e) {
        this.initialise_panel();
        this.panel.display_panel(e);
    },

    /**
     * Display the custom help tooltip.
     *
     * @method display_panel
     * @param {EventFacade} e
     */
    display_custom_panel: function(e) {
        this.initialise_panel();
        this.panel.display_custom_panel(e);
    },

    /**
     * Display the panel.
     *
     * @method initialise_panel
     * @param {EventFacade} e
     */
    initialise_panel: function() {
        if (!this.panel) {
