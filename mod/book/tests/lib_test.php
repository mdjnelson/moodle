...
class mod_book_lib_testcase extends advanced_testcase {
    ...
    public function test_book_core_calendar_is_event_visible() {
        $this->setAdminUser();
        ...
        $this->assertTrue(mod_book_core_calendar_is_event_visible($event));
    }

    public function test_book_core_calendar_is_event_visible_event_as_non_user() {
        global $CFG;
        ...
        $this->assertFalse(mod_book_core_calendar_is_event_visible($event));
    }
