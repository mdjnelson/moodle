...
class override_deleted extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/quiz/overrides.php', array('cmid' => $this->context->instanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quiz', 'delete override', 'overrides.php?cmid=' . $this->context->instanceid,
