...
class mod_page_lib_testcase extends advanced_testcase {
    ...
    public function test_page_core_calendar_is_event_visible() {
        $this->resetAfterTest();
        $this->setAdminUser();
        ...
        $this->assertTrue(mod_page_core_calendar_is_event_visible($event));
    }

    public function test_page_core_calendar_is_event_visible_as_non_user() {
        global $CFG;
        ...
        $this->assertFalse(mod_page_core_calendar_is_event_visible($event));
    }
