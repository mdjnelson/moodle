...
Feature: Group assignment submissions
  ...
  Scenario: Confirm that the grading status changes for each group member
    ...
    And I follow "Test assignment name"
    And I follow "View/grade all submissions"
    Then I should see "Submitted for grading" in the "//tr[@id='mod_assign_grading_r0']" "xpath_element"
    And I should see "Submitted for grading" in the "//tr[@id='mod_assign_grading_r1']" "xpath_element"
    And I should see "Submitted for grading" in the "//tr[@id='mod_assign_grading_r2']" "xpath_element"
    And I should see "Submitted for grading" in the "//tr[@id='mod_assign_grading_r3']" "xpath_element"
