...
class mod_folder_lib_testcase extends advanced_testcase {
    ...
    public function test_folder_core_calendar_is_event_visible() {
        $this->setAdminUser();
        ...
        $this->assertTrue(mod_folder_core_calendar_is_event_visible($event));
    }

    public function test_folder_core_calendar_is_event_visible_as_non_user() {
        global $CFG;
        ...
        $this->assertFalse(mod_folder_core_calendar_is_event_visible($event));
    }
