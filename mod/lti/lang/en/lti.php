...
$string['crontask'] = 'External tool removal of expired access tokens';
...
$string['errorjwtnotsupportedforlti2'] = 'JWT security not supported with LTI 2';
...
$string['ltiversion'] = 'Security profile';
$string['ltiversion_help'] = 'The security profile used for signing messages and service requests: LTI 1.0-1.2 and LTI 2.0 use OAuth 1.0A; LTI 1.3.0 uses JWTs.';
